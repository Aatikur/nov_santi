...
<?php include_once 'php/database/connection.php';?>
	...
	<div id='invoice-POS'>		
		...
		<div class='text-center' id='top'>
			<div class='logo'><img src='uploads/santirekhalogo.png' alt=''></div>
		</div><!--End InvoiceTop-->
		...
		<div id='bot'>
			<div id='table'>
				...
				if ($res_user_order = $connection->query($sql_user_order)) {
					...
					<tr class='service'>
						<td class='tableitem'><p class='itemtext'><span class='font-700'><?=$user_order_row['p_name']?></span> <br>MRP :<?= $user_order_row['mrp']?></p></td>
					...
					<tr class='tabletitle botton-tail'>
						...
						<td class='payment'><h2><?php echo number_format($cash_payment,2,'.', '')?></h2></td>
					</tr>  
					<tr class='tabletitle botton-tail'>
