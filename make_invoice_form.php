    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_content table-responsive">
        <table class="table table-striped jambo_table bulk_action" cellspacing="0" width="100%">
          ...
          <tbody>
            <?php
              $sql_user_order = "SELECT `product`.*,`temp_invoice`.`quantity` as quantity_o,`temp_invoice`.`id` as inv_id  FROM `temp_invoice` INNER JOIN `product` ON `product`.`id` = `temp_invoice`.`p_id` ";
